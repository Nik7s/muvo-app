...
export default function LoginScreen() {
  return (
    ...
    >
      ...
      <View className="h-full w-full flex justify-evenly pt-40 pb-10 z-10">
        ...
        <View className="flex items-center mx-5 space-y-4">
          ...
          <View className="flex-row justify-center">
            <Text className="text-neutral-300">Don't have an account? </Text>
            <TouchableOpacity onPress={() => router.push("/signup")}>
              <Text className="text-green-500">SignUp</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
